      ...
      <Row className={s.root}>
        ...
        <Col lg={9}>
          <Widget id="Animate.css">
            <h3>Animate.css</h3>
            <p>
              animate.css is a bunch of cool, fun, and cross-browser animations for you to use in your projects. Great for emphasis, home
            ...
            <p>
              ...
              <a href="https://github.com/daneden/animate.css/" target="_blank" rel="noopener noreferrer">
                Animate.css
              </a>
            </p>
          </Widget>
          ...
          <Widget id="Font-Awesome">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/components/icons">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
          ...
          <Widget id="Formsy-React">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/formsy/formsy-react" target="_blank" rel="noopener noreferrer">
                Formcy React
              </a>
            </p>
          </Widget>
          <Widget id="Fullcalendar">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://fullcalendar.io/docs/react" target="_blank" rel="noopener noreferrer">
                Fullcalendar
              </a>
            </p>
          </Widget>
          <Widget id="Glyphicons-Halflings">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://getbootstrap.com/docs/3.3/components/" target="_blank" rel="noopener noreferrer">
                Glyphicons
              </a>
            </p>
          </Widget>
          ...
          <Widget id="React-Sparkline">
            ...
            <p>
              This React.js plugin makes it easy to generate a number of different types of sparklines directly in the browser, using few
              lines of JSX.
            </p>
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/borisyankov/react-sparklines" target="_blank" rel="noopener noreferrer">
                React Sparklines
              </a>
            </p>
          </Widget>
          <Widget id="React-Toastify">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/ui/notifications">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/fkhadra/react-toastify" target="_blank" rel="noopener noreferrer">
                react-toastify
              </a>
            </p>
          </Widget>
          <Widget id="Rc-color-picker">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/react-component/color-picker" target="_blank" rel="noopener noreferrer">
                Color Picker
              </a>
            </p>
          </Widget>
          <Widget id="Rc-Hammerjs">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/JedWatson/react-hammerjs" target="_blank" rel="noopener noreferrer">
                HammerJS
              </a>
            </p>
          </Widget>
          <Widget id="React-Autosize-Textarea">
            ...
            <p>
              A light replacement for built-in <code>&lt;textarea /></code> component which automatically adjusts its height to match the
              content.
            </p>
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/buildo/react-autosize-textarea" target="_blank" rel="noopener noreferrer">
                Textarea
              </a>
            </p>
          </Widget>
          <Widget id="React-Datetime">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/YouCanBookMe/react-datetime" target="_blank" rel="noopener noreferrer">
                DateTime
              </a>
            </p>
          </Widget>
          ...
          <Widget id="React-Maskedinput">
            ...
            <p>
              A React component for <code>&lt;input></code> masking, built on top of inputmask-core.
            </p>
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/insin/react-maskedinput" target="_blank" rel="noopener noreferrer">
                Masked Input
              </a>
            </p>
          </Widget>
          <Widget id="React-MDE">
            <h3>React-mde</h3>
            <p>A simple yet powerful and extensible Markdown Editor editor for React. React-mde is built on top of Draft.js.</p>

            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/andrerpena/react-mde" target="_blank" rel="noopener noreferrer">
                ReactMDE
              </a>
            </p>
          </Widget>
          ...
          <Widget id="React-Shuffle">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/FormidableLabs/react-shuffle" target="_blank" rel="noopener noreferrer">
                Shuffle
              </a>
            </p>
          </Widget>
          <Widget id="React-Slick">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/ecommerce/product">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/FormidableLabs/react-shuffle" target="_blank" rel="noopener noreferrer">
          ...
          <Widget id="React-Sortable">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/clauderic/react-sortable-hoc" target="_blank" rel="noopener noreferrer">
                React Sortable
              </a>
            </p>
          </Widget>
          ...
          <Widget id="Rickshaw">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/shutterstock/rickshaw" target="_blank" rel="noopener noreferrer">
                Rickshaw
              </a>
            </p>
          </Widget>
          <Widget id="Skycons">
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a href="https://github.com/darkskyapp/skycons" target="_blank" rel="noopener noreferrer">
                Skycons
              </a>
            </p>
          </Widget>
          <Widget id="Other">
            ...
            <ul className="check-list">
              ...
              <li className="lead">
                <a className="fw-semi-bold" href="https://react-bootstrap.github.io/" rel="noopener noreferrer" target="_blank">
                  {" "}
                  React Bootstrap
                </a>
                . With React Bootstrap you can build responsive, mobile-first projects on the web using React.js and the world's most
                popular front-end CSS library — Bootstrap v4.
              </li>
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/highcharts/highcharts-react" rel="noopener noreferrer" target="_blank">
                  {" "}
                  highcharts-react
                </a>
              ...
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/apexcharts/react-apexcharts" rel="noopener noreferrer" target="_blank">
                  {" "}
                  react-apexcharts
                </a>
              ...
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/hustcc/echarts-for-react" rel="noopener noreferrer" target="_blank">
                  {" "}
                  echarts-for-react
                </a>
              ...
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/olahol/react-tagsinput" rel="noopener noreferrer" target="_blank">
                  {" "}
                  react-tagsinput
                </a>
              ...
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/tannerlinsley/react-table" rel="noopener noreferrer" target="_blank">
                  {" "}
                  react-table
                </a>
                . This React package offers an easy and intuitive way of displaying Bootstrap-styled grids with data coming either from the
                client or from the server.
              </li>
              <li className="lead">
                <a className="fw-semi-bold" href="https://github.com/unsplash/react-trend" rel="noopener noreferrer" target="_blank">
                  {" "}
                  react-trend
                </a>
