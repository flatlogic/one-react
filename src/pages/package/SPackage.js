      ...
      <div>
        ...
        <Row>
          <Col md={6}>
            <Widget
              title={
                <p className={"fw-bold"}>React JS Version</p>
              } customDropDown
            >
              ...
              <button className="btn btn-transparent btn-block disabled">(You are here)</button>
            </Widget>
          </Col>
          <Col md={6}>
            <Widget
              title={
                <p className={"fw-bold"}>Angular Version</p>
              } customDropDown
            >
          ...
          <Col md={6}>
            <Widget
              title={
                <p className={"fw-bold"}>AngularJS 1.X Version</p>
              } customDropDown
            >
          ...
          <Col md={6}>
            <Widget
              title={
                <p className={"fw-bold"}>Pure HTML5 Version</p>
              } customDropDown
            >
          ...
          <Col md={6}>
            <Widget
              title={
                <p className={"fw-bold"}>Vue JS Version</p>
              } customDropDown
            >
