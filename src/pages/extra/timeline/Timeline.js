...
const Links = () => {
  return (
    <ul className={s.postLinks}>
      ...
      <li><a href="#"><span className="text-danger"><i className="fa fa-heart"></i> Like</span></a></li>
...
const Links2 = () => {
  return (
      <ul className={s.postLinks}>
        <li><a href="#">1 hour</a></li>
        <li><a href="#"><span className="text-danger"><i className="fa fa-heart-o"></i> Like</span></a></li>
        <li><a href="#">Comment</a></li>
      </ul>
  )}
          ...
          <ul className={s.timeline}>
            <li>
              <div className={s.timelineBadge}>
                <a><i className={`${s.fa} fa fa-circle`}><img src={email} alt=""/></i></a>
              </div>
