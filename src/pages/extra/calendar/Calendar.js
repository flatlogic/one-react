          ...
          <Col lg={4} xs={12} md={6}>
            <Widget title={<p className={"fw-bold"}>Draggable Events</p>}>
              ...
              >
                ...
                >
                  <div className={`${s.customExternalEvent} bg-inverse text-white`}>
                    Buy this template
                  </div>
                </div>
                <div
                  ...
                  className="external-event draggable"
                >
                  <div className={`${s.customExternalEvent} bg-primary text-white`}>
                  Study some Node
                  </div>
                </div>
                <div
                  ...
                  className="external-event draggable"
                >
                  <div className={`${s.customExternalEvent} bg-info text-white`}>
                  Make a tea
                  </div>
                </div>
                <div
                  ...
                  className="external-event draggable"
                >
                  <div className={`${s.customExternalEvent} bg-success text-white`}>
                  Go to school
                  </div>
                </div>
                <div
                  ...
                  className="external-event draggable"
                >
                  <div className={`${s.customExternalEvent} bg-warning text-white`}>
                  Open windows
                  </div>
                </div>
              </div>
