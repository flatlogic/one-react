    ...
    return (
      <div className={s.root}>
              ...
              <FormGroup>
                <Form>
                  ...
                  <FormGroup row>
                    <Label md={4} />
                    <Col md={7}>
                      <Button color="warning" type="submit" className="mr-xs">Save</Button>
        ...
        <Row>
                ...
                <FormGroup row>
                  ...
                  <Col md={9}>
                    ...
                    <div className="text-md-right mt-xs">
                      <Button color="warning" className="mr-xs">Save</Button>
          ...
          <Col lg="6" md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}><i className="fa fa-list-alt" /> Selects </p>} customDropDown
            >
        ...
        <Row>
          <Col md="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Checkbox Controls</p>} customDropDown
            >
              <Row>
                <Col lg="4">
                  <Form>
        ...
        <Row>
          ...
          <Col lg="6" md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Simple file uploads</p>} customDropDown
            >
              <Form>
