        ...
        <Row>
          <Col sm={12}>
            <Widget
              ...
              title={<div><p style={{ fontWeight: 700 }}>
                  Wizard&nbsp;
                ...
                <div className="description">
                  <ul className="pager wizard">
                    <li className="previous">
                      <Button disabled={currentStep === 1} color="default" onClick={this.previousStep}><i
                    ...
                    {currentStep < count &&
                    <li className="next">
                      <Button color="success" onClick={this.nextStep}>Next <i className="fa fa-caret-right" /></Button>
                    </li>
                    }
                    {currentStep === count &&
                    <li className="finish">
