...
import { Row, Col, Button, ButtonGroup, ButtonToolbar, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem } from "reactstrap"
      ...
      <div>
        <Row>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Color Options</p>} customDropDown>
              <div>
          ...
          {/* Size variants */}
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Size Variants</p>} customDropDown>
              <div>
                <p className="fs-mini text-muted">
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Outline Buttons</p>} customDropDown>
              <div>
                <p className="fs-mini">
                  In need of a button, but not the hefty background colors they bring? Use <code>outline</code> property to remove all
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Rounded Buttons</p>} customDropDown>
              <div>
                <p className="fs-mini">
                ...
                <p>
                  ...
                  <br />
                  <Button outline color="warning" className="btn-rounded mb-md mr-md">
                    Warning
                  </Button>
                  <Button outline color="danger" className="btn-rounded mb-md mr-md">
                    Danger
                  </Button>
                  <Button outline color="gray" className="btn-rounded mb-md mr-md">
                    Gray
                  </Button>
                  <Button outline color="inverse" className="btn-rounded mb-md mr-md">
                    Inverse
                  </Button>
                </p>
              </div>
          ...
          {/* Block Buttons */}
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Block Buttons</p>} customDropDown>
              <div>
                <p className="fs-mini text-muted">
                  Create block level buttons - those that span the full width of a parent— by adding <code>block</code>
                  to <code>&lt;Button&gt;</code> component. Great for menu & social buttons.
                </p>
          ...
          {/* Disabled Buttons */}
          <Col md={6} sm={12} xs={12}>
            <Widget title={<p style={{ fontWeight: 700 }}>Disabled Buttons</p>} close collapse>
              <div>
                <p className="fs-mini text-muted">
                  Make buttons look unclickable by fading them back 50%. Add the <code>disabled</code> to <code>&lt;Button&gt;</code>{" "}
                  component.
                </p>
                <p>
          ...
          <Col md={6} sm={12} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  Group a series of buttons together on a single line with the button group. Add on optional JavaScript radio and checkbox
          ...
          <Col md={6} sm={12} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  Add dropdown menus to nearly anything with this simple plugin, including the buttons, navbar, tabs, and pills. Both solid
                  & segmented dropdown options available.
                </p>

                <div className="mb-xs">
                  <ButtonDropdown isOpen={this.state.dropdownOpenOne} toggle={this.toggleOne} className="mr-md mb-md">
                  ...
                  <ButtonDropdown isOpen={this.state.dropdownOpenTwo} toggle={this.toggleTwo} className="mr-md mb-md">
                ...
                <div className="mb-xs">
                  <ButtonDropdown isOpen={this.state.dropdownOpenThree} toggle={this.toggleThree} className="mr-md">
              ...
              <Row>
                ...
                <Col md={4} sm={6} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    ...
                    <code>ButtonGroup</code> to a group of checkboxes for checkbox style toggling on btn-group.
                  </p>
                  <div className="mb-md">
                    <ButtonGroup>
                      <Button color="default" onClick={() => this.onCheckboxBtnClickOne(1)} active={this.state.cSelectedOne.includes(1)}>
                        Left way
                      </Button>
                      <Button color="default" onClick={() => this.onCheckboxBtnClickOne(2)} active={this.state.cSelectedOne.includes(2)}>
                        Middle way
                      </Button>
                      <Button color="default" onClick={() => this.onCheckboxBtnClickOne(3)} active={this.state.cSelectedOne.includes(3)}>
                        Right way
                      </Button>
                    </ButtonGroup>
                  </div>
                ...
                <Col md={4} sm={12} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    Do more with buttons. Control button states or create groups of buttons for more components like toolbars. Use{" "}
                    <code>ButtonGroup</code> to a group of radio inputs for radio style toggling on btn-group.
                  </p>
                  <div className="mb-md">
                    <ButtonGroup>
                      <Button color="default" onClick={() => this.onRadioBtnClickOne(1)} active={this.state.rSelectedOne === 1}>
                        Left way
                      </Button>
                      <Button color="default" onClick={() => this.onRadioBtnClickOne(2)} active={this.state.rSelectedOne === 2}>
                        Middle way
                      </Button>
                      <Button color="default" onClick={() => this.onRadioBtnClickOne(3)} active={this.state.rSelectedOne === 3}>
                        Right way
                      </Button>
                    </ButtonGroup>
                  </div>
                  <div className="mb-sm">
                    <ButtonGroup>
                      <Button size="sm" color="default" onClick={() => this.onRadioBtnClickTwo(1)} active={this.state.rSelectedTwo === 1}>
                        Left way
                      </Button>
                      <Button size="sm" color="default" onClick={() => this.onRadioBtnClickTwo(2)} active={this.state.rSelectedTwo === 2}>
                        Middle way
                      </Button>
                      <Button size="sm" color="default" onClick={() => this.onRadioBtnClickTwo(3)} active={this.state.rSelectedTwo === 3}>
                        Right way
                      </Button>
                    </ButtonGroup>
                  </div>
