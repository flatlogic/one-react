      ...
      <div>
        <Row>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Color Options</p>} customDropDown
            >
              <div>
                ...
                <p className="text-left">
                  <Button color="default" className="mb-md mr-md">Default</Button>
                  <Button color="primary" className="mb-md mr-md">Primary</Button>
                  <Button color="info" className="mb-md mr-md">Info</Button>
                  <Button color="success" className="mb-md mr-md">Success</Button>
                  <Button color="warning" className="mb-md mr-md">Warning</Button>
                  <Button color="danger" className="mb-md mr-md">Danger</Button>
                  <Button color="gray" className="mb-md mr-md">Gray</Button>
                  <Button color="inverse" className="mb-md mr-md">Inverse</Button>
                </p>
              </div>
            </Widget>
          </Col>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Size Variants</p>} customDropDown
            >
              <div>
                <p className="fs-mini text-muted">
                ...
                <p>
                  <Button color="default" size="lg" className="mb-md mr-sm">Large button</Button>
                  <Button color="primary" className="mb-md mr-md">Default button</Button>
                  <Button color="info" size="sm" className="mb-md mr-md">Small button</Button>
                  <Button color="success" size="xs" className="mb-md mr-md">Tiny button</Button>
                </p>
              </div>
            </Widget>
          </Col>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Outline Buttons</p>} customDropDown
            >
              <div>
                <p className="fs-mini">
                ...
                <p>
                  <Button outline color="default" className="mb-md mr-md">Default</Button>
                  <Button outline color="primary" className="mb-md mr-md">Primary</Button>
                  <Button outline color="info" className="mb-md mr-md">Info</Button>
                  <Button outline color="success" className="mb-md mr-md">Success</Button>
                  <Button outline color="warning" className="mb-md mr-md">Warning</Button>
                  <Button outline color="danger" className="mb-md mr-md">Danger</Button>
                  <Button outline color="gray" className="mb-md mr-md">Gray</Button>
                  <Button outline color="inverse" className="mb-md mr-md">Inverse</Button>
                </p>
              </div>
            </Widget>
          </Col>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Rounded Buttons</p>} customDropDown
            >
              <div>
                <p className="fs-mini">
                ...
                <p>
                  <Button color="default" className="btn-rounded-f mb-md mr-md">Default</Button>
                  ...
                  <Button outline color="inverse" className="btn-rounded mb-md mr-md">Inverse</Button>
                </p>
              </div>
            </Widget>
          </Col>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Block Buttons</p>} customDropDown
            >
              <div>
                <p className="fs-mini text-muted">
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Disabled Buttons</p>} close collapse
            >
              <div>
                <p className="fs-mini text-muted">
                ...
                <p>
                  <Button color="primary" disabled className="mr-md">Primary button</Button>
                  <Button color="default" disabled className="mr-md">Button</Button>
                </p>
                <p>
                  <Button color="success" size="sm" disabled className="mr-md">Primary Link</Button>
                  <Button color="default" size="sm" disabled className="mr-md">Link</Button>
                </p>
              </div>
            </Widget>
          </Col>
