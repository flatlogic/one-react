      ...
      <div>
        <Row>
          <Col xs={12} md={6}>
            <Widget
              className="mb-xlg"
              title={<p style={{ fontWeight: 700 }}>Live Demo</p>} customDropDown
            >
              <p>
                Toggle a working modal demo by clicking the button below. It
                will slide down and fade in from the top of the page.
              </p>
              <Button className="mr-sm" color="warning" onClick={() => this.toggle('demo')}>Demo</Button>
              <Button color="warning" onClick={() => this.toggle('scrollingLong')}>Scrolling long content</Button>
            </Widget>
            <Widget
            ...
            >
              ...
              <Button className="mr-sm" color="warning" onClick={() => this.toggle('large')}>Large modal</Button>
              <Button color="warning" onClick={() => this.toggle('small')}>Small modal</Button>
            </Widget>
          </Col>
          <Col xs={12} md={6}>
            <Widget
            ...
            >
              ...
              <div className="bg-light p-3">
                <Button color="warning" onClick={() => this.toggle('launch')}>Launch</Button>
        ...
        <Modal isOpen={demo} toggle={() => this.toggle('demo')}>
          ...
          <ModalFooter>
            <Button color="default" className={"text-capitalize"} onClick={() => this.toggle('demo')}>Close</Button>
        ...
        <Modal isOpen={scrollingLong} toggle={() => this.toggle('scrollingLong')}>
          ...
          <ModalFooter>
            <Button color="default" onClick={() => this.toggle('scrollingLong')} className={"text-capitalize"}>Close</Button>
            <Button color="warning" className={"text-capitalize"}>Save changes</Button>
          </ModalFooter>
        </Modal>
        ...
        <Modal isOpen={launch} toggle={() => this.toggle('launch')}>
          ...
          <ModalBody className="bg-white text-white">
            <Container fluid>
              <Row>
                <Col md={4}><div className="h-100 w-100 bg-warning p-2">.col-md-4</div></Col>
                <Col md={4} className="ml-auto"><div className="h-100 w-100 bg-warning p-2">.col-md-4 .ml-auto</div></Col>
              </Row>
              <Row className="mt-sm">
                <Col md={3} className="ml-auto"><div className="h-100 w-100 bg-warning p-2">.col-md-3 .ml-auto</div></Col>
                <Col md={4} className="ml-auto"><div className="h-100 w-100 bg-warning p-2">.col-md-4 .ml-auto</div></Col>
              </Row>
              <Row className="mt-sm">
                <Col md={6} className="ml-auto"><div className="h-100 w-100 bg-warning p-2">.col-md-6 .ml-auto</div></Col>
              </Row>
            </Container>
          </ModalBody>
          <ModalFooter>
            <Button color="default" onClick={() => this.toggle('launch')} className={"text-capitalize"}>Close</Button>
            <Button color="warning" className={"text-capitalize"}>Save changes</Button>
          </ModalFooter>
        </Modal>
      </div>
